...
{
    public class CliMonitoringDetailViewModel : INotifyPropertyChanged
    {

        public ObservableCollection<CliMonitoringData> Items { get { return Item; } set { Item = value; OnPropertyChanged(nameof(Items)); } }

        public ObservableCollection<CliMonitoringData> Item = new ObservableCollection<CliMonitoringData>();
        ...
        public CliLockInfoData CliLockInfo
        {
            get { return clilockinfo; }
            set
            {
                clilockinfo = value;
                OnPropertyChanged(nameof(CliLockInfoData));
            }
        }
        private CliLockInfoData clilockinfo;
        ...
        {
            await Application.Current.MainPage.Navigation.PushAsync(new CliTaskMonitoringMapPage(CONFNO));
        }
        ...
        public async void DateSearch()
        {
            ...
            {
                IsLoading = true;
                Items = new ObservableCollection<CliMonitoringData>();
                ...
                int num1 = DateTime.Compare((DateTime)(lkMstData[0].REFDT1), SelectedStartDate);
                int num2 = DateTime.Compare((DateTime)(lkMstData[0].REFDT1), SelectedEndDate);
                    ...
                    if (lkMstData[0].REFDA1 != null)
                    {
                        ...
                        if (lkMstData[0].ILSID != null)
                        {
                            ...
                            if (siehisData.Count > 0)
                            {
                                ...
                                Items.Add(new CliMonitoringData(lkMstData[0].REFDT1, LKTYP, empInfoList[0].EMPNM, lkMstData[0].ILSID, areaData[0].AREANM,
                                siehisData[0].EVTDT, lockClose, getOn, getOff, lockoff, crushing, CONFNO));

                            }
                            else
                            {
                                Items.Add(new CliMonitoringData(lkMstData[0].REFDT1, LKTYP, empInfoList[0].EMPNM, null, null,
                ...
                {
                    await Application.Current.MainPage.DisplayAlert("오류", "조회하신 날짜에 작업이 없습니다.", "OK");
                    IsLoading = false;
        ...
        #region CliMonitoringDetailViewModel
        public CliMonitoringDetailViewModel()
        {
