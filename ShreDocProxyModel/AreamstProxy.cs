...
// RUN : imatecc gen_md -title shredoc -object "areamst" -output "AreamstProxy.cs" -nspace "ShreDoc.ProxyModel" -mtype "proxy"
...
/// <summary>
    ...
    /// </summary>    
    public class AreamstModelList  : List<AreamstModel>
    {
        /// <summary>
        /// 생성자
        /// </summary>
