...
{
    public class ProvisionViewModel : INotifyPropertyChanged
    {
                    ...
                    whereFieldConditions = new DIMWhereFieldCondition[]
    {
                ...
                if (lkMstData.Count > 0)
                {
                    foreach (var item in lkMstData)
                    {
                        ...
                        StackBackgroundColor = Colors.DeepSkyBlue;
                        ...
                        else if (item.REFDA1 != null && sierepData.Count == 0)
                            lockStatus = "봉인준비";

                        else if (item.REFDA1 != null && sierepData.Count > 0 && sierepREPTYPB != null)
                            lockStatus = "상차";

                        else if (item.REFDA1 != null && sierepData.Count > 0 && sierepREPTYPC != null)
                            lockStatus = "하차";

                        else if (item.REFDA1 != null && sierepData.Count > 0 && sierepREPTYPD != null)
                            lockStatus = "봉인해제";
