...
{
    public partial class DocCrushingProofPage : ContentPage
    {
        /// <summary>
        /// Confno
        /// </summary>
        ...
        public DocCrushingProofPage(string CONFNO)
        {
            InitializeComponent();
            ConfNO = CONFNO;
                ...
                var paramDic = new Dictionary<string, string>
        {
            ...
            { "CONFNO", ConfNO}
                ...
                var data = await docService.Print("CrushingProof", paramDic, false, "default", true);
                // 대기 시간 추가
                ...
                {
                    // 파일 경로 설정
                    var path = Path.Combine(FileSystem.AppDataDirectory, "CrushingProof.pdf");
                ...
                {
                    string pdfFileName = "CrushingProof.pdf";
