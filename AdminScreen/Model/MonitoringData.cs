...
namespace AdminScreen.Models
{
    public class MonitoringData : INotifyPropertyChanged
    {
        ...
        public MonitoringData(DateTime? provisionDate, string lktyp, string name ,string boxname, string location, DateTime? lockprepare, DateTime? lockClose, DateTime? getOn, DateTime? getOff, DateTime? lockoff, DateTime? crushing, string confno)
        {
